...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ public_asset('assets/logicsgrid-icon-transparent.png') }}">
    <link rel="apple-touch-icon" href="{{ public_asset('assets/logicsgrid-icon-transparent.png') }}">
